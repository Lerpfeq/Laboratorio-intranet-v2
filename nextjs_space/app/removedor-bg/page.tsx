  ...
  return (
    <div>
      ...
      <main className="container">
        <h2 className="page-title">Removedor de Background</h2>
        <p style={{ color: '#666', marginBottom: '2rem' }}>Ferramenta de remocao de background em desenvolvimento. Volte em breve!</p>
