  ...
  return (
    <div>
      <header className="header">
        <div className="header-container">
          ...
          <nav className="nav-tabs">
            ...
            <Link href="/residuos">Residuos</Link>
          </nav>
      ...
      <main className="container">
        <h2 className="page-title">Gestao de Residuos</h2>
        <p style={{ color: '#666', marginBottom: '2rem' }}>Sistema de gestao de residuos em desenvolvimento. Volte em breve!</p>
