...
// Códigos da planilha (mesma lista do endpoint)
const CODES = [
...
async function checkMissingCodes() {
  console.log('🔍 Checking for missing codes...\n');
  ...
  console.log('\n═══════════════════════════════════════');
  console.log(`📊 RESULTS:`);
  console.log(`   Total codes in spreadsheet: ${CODES.length}`);
